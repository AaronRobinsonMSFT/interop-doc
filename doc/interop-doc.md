...
The opposite case is also possible &ndash; blittable but not unmanaged. Single dimension arrays of blittables types are considered blittable by the interop system but are not unmanaged types.
